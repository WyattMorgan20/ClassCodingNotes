...
public class BottleCounterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_bottle_counter, container, false);

        addBTN = getView().findViewById(R.id.addBottle);
        removeBTN = getView().findViewById(R.id.removeBottle);
    }
}